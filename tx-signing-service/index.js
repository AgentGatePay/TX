...
const GATEWAY_PRIVATE_KEY = process.env.GATEWAY_PRIVATE_KEY;  // Client's wallet private key

// 🔒 SECURITY: Only this specific API key can use this signing service
const OWNER_API_KEY = process.env.OWNER_API_KEY;  // Client's AgentGatePay API key
